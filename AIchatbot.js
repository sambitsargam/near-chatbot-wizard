...
const API_URL =
  "https://api.sambitsargam.in";
// changing apis
const AIR_API_KEY = "42152a698f40410780023e31753683e9";
...
const sender = state.sender || "Sambit Saragm";
  ...
  <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center p-3">
      ...
      <div className="d-flex flex-row align-items-center">
        ...
        <Widget
          src="sambit.testnet/widget/web3connect"
    ...
    <Widget
      src="sambit.testnet/widget/display"
    ...
    <div class="card-footer text-muted justify-content-start align-items-center p-3">
      <Widget
        src="sambit.testnet/widget/input"
        props={{
          value,
          inputSubmitLabel,
          handleButtonClick,
